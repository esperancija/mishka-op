...
static int debug_log_mode = 0;//POLARSSL_DEBUG_DFL_MODE;
...
char *debug_fmt( const char *format, ... )
{
    ...
    vsnprintf( str, BUFFER_LEN-1, (char *)format, argp );
    va_end( argp );
...
//    }
//
//    snprintf( str, maxlen, "%s(%04d) %d,%ds: %s\n", file, line,
