...
#define POLARSSL_DEBUG_LOG_FULL         1 /**< Include file:line in log lines */
#define POLARSSL_DEBUG_LOG_RAW          0 /**< Only log raw debug lines */
...
#define SSL_DEBUG_ECP( level, text, X )                  \
    debug_print_ecp( ssl, level, __FILENAME__, __LINE__, text, X );
#endif
