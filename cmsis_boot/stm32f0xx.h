...
typedef struct
{
  ...
  __IO uint32_t DHR12R2;      /*!< DAC channel1 12-bit right-aligned data holding register,  Address offset: 0x08 */
  __IO uint32_t DHR12L2;      /*!< DAC channel1 12-bit left aligned data holding register,   Address offset: 0x0C */
  __IO uint32_t DHR8R2;       /*!< DAC channel1 8-bit right aligned data holding register,   Address offset: 0x10 */

       uint32_t RESERVED[3];  /*!< Reserved,                                                                 0x14 */
...
#define DMA1_Channel6_BASE    (AHBPERIPH_BASE + 0x0000006C)
#define DMA1_Channel7_BASE    (AHBPERIPH_BASE + 0x00000080)
#define DMA2_BASE             (AHBPERIPH_BASE + 0x00000400)
#define DMA2_Channel1_BASE    (AHBPERIPH_BASE + 0x00000408)
#define DMA2_Channel2_BASE    (AHBPERIPH_BASE + 0x0000041C)
#define DMA2_Channel3_BASE    (AHBPERIPH_BASE + 0x00000430)
#define DMA2_Channel4_BASE    (AHBPERIPH_BASE + 0x00000444)
#define DMA2_Channel5_BASE    (AHBPERIPH_BASE + 0x00000458)
...
#define DMA2_CSELR			((DMA_CSELR_TypeDef*   ) DMA2_CSELR_BASE)
...
#define  DAC_CR_EN2                          ((uint32_t)0x00010000)        /*!<DAC channel1 enable */
#define  DAC_CR_BOFF2                        ((uint32_t)0x00020000)        /*!<DAC channel1 output buffer disable */
#define  DAC_CR_TEN2                         ((uint32_t)0x00040000)        /*!<DAC channel1 Trigger enable */
...
#define TSC_CR_START						((uint32_t)0x00000002)			/*!<Start a new acquisition */
...
#define TSC_CR_IODEF						((uint32_t)0x00000010)			/*!<I/O Default mode*/
/*!<Max count value*/
#define TSC_CR_MCV  						((uint32_t)0x000000E0)			/*!<MCV all bits (value 111-reserved)*/
#define TSC_CR_MCV_0						((uint32_t)0x00000020)			/*!<MCV bit 0*/
#define TSC_CR_MCV_1						((uint32_t)0x00000040)			/*!<MCV bit 1*/
#define TSC_CR_MCV_2						((uint32_t)0x00000080)			/*!<MCV bit 2*/
/*!<pulse generator prescaler*/
#define TSC_CR_PGPSC						((uint32_t)0x00007000)			/*!<PGPSC all bits*/
#define TSC_CR_PGPSC_0						((uint32_t)0x00001000)			/*!<PGPSC bit 0*/
#define TSC_CR_PGPSC_1						((uint32_t)0x00002000)			/*!<PGPSC bit 1*/
#define TSC_CR_PGPSC_2						((uint32_t)0x00004000)			/*!<PGPSC bit 2*/
...
#define TSC_CR_SSD							((uint32_t)0x00FE0000)			/*!<SSD all bits*/
#define TSC_CR_SSD_0						((uint32_t)0x00020000)		  /*!<SSD bit 0*/
#define TSC_CR_SSD_1						((uint32_t)0x00040000)		  /*!<SSD bit 1*/
#define TSC_CR_SSD_2						((uint32_t)0x00080000)		  /*!<SSD bit 2*/
#define TSC_CR_SSD_3						((uint32_t)0x00100000)		  /*!<SSD bit 3*/
#define TSC_CR_SSD_4						((uint32_t)0x00200000)		  /*!<SSD bit 4*/
#define TSC_CR_SSD_5						((uint32_t)0x00400000)		  /*!<SSD bit 5*/
#define TSC_CR_SSD_6						((uint32_t)0x00800000)		  /*!<SSD bit 6*/
/*!<Charge transfer pulse low*/
#define TSC_CR_CTPL							((uint32_t)0x0F000000)			/*!<CTPL all bits*/
#define TSC_CR_CTPL_0						((uint32_t)0x01000000)			/*!<CTPL bit 0*/
#define TSC_CR_CTPL_1						((uint32_t)0x02000000)			/*!<CTPL bit 1*/
#define TSC_CR_CTPL_2						((uint32_t)0x04000000)			/*!<CTPL bit 2*/
#define TSC_CR_CTPL_3						((uint32_t)0x08000000)			/*!<CTPL bit 3*/
/*!<Charge transfer pulse high*/
#define TSC_CR_CTPH							((uint32_t)0xF0000000)			/*!<CTPH all bits*/
#define TSC_CR_CTPH_0						((uint32_t)0x10000000)			/*!<CTPH bit 0*/
#define TSC_CR_CTPH_1						((uint32_t)0x20000000)			/*!<CTPH bit 1*/
#define TSC_CR_CTPH_2						((uint32_t)0x30000000)			/*!<CTPH bit 2*/
#define TSC_CR_CTPH_3						((uint32_t)0x40000000)			/*!<CTPH bit 0*/

/*******************  Bit definition for TSC_IER register  *********************/
#define TSC_IER_EOAIE						((uint8_t)0x01)					/*!<End of acquisition interrupt enable*/
#define TSC_IER_MCEIE						((uint8_t)0x02)					/*!<Max count error interrupt enable*/
/*******************  Bit definition for TSC_ICR register  *********************/
#define TSC_ICR_EOAIC						((uint8_t)0x01)					/*!<End of acquisition interrupt clear*/
#define TSC_ICR_MCEIC						((uint8_t)0x02)					/*!<Max count error interrupt clear*/
/*******************  Bit definition for TSC_ISR register  *********************/
#define TSC_ISR_EOAF						((uint8_t)0x01)					/*!<End of acquisition flag*/
#define TSC_ISR_MCEF						((uint8_t)0x02)					/*!<Max count error flag*/
/*******************  Bit definition for TSC_IOHCR register  *********************/
#define TSC_IOHCR_G1_IO1					((uint32_t)0x00000001)			/*!<Gx_IOy Schmitt trigger hysteresis mode*/
...
#define TSC_IOASCR_G1_IO1					((uint32_t)0x00000001)			/*Gx_IOy analog switch enable*/
...
#define TSC_IOSCR_G1_IO1					((uint32_t)0x00000001)			/*Gx_IOy sampling mode*/
...
#define TSC_IOCCR_G1_IO1					((uint32_t)0x00000001)			/*Gx_IOy channel mode*/
...
#define TSC_IOGCSR_GE							((uint32_t)0x000000FF)
...
#define TSC_IOGCSR_G7E						((uint32_t)0x00000040)
#define TSC_IOGCSR_G8E						((uint32_t)0x00000080)
/*Analog I/O group x enable*/
#define TSC_IOGCSR_GS							((uint32_t)0x00FF0000)
...
#define TSC_IOGCSR_G7S						((uint32_t)0x00400000)
#define TSC_IOGCSR_G8S						((uint32_t)0x00800000)
/*******************  Bit definition for TSC_IOG1CR register  *********************/
//#define TSC_IOG1CR								((uint32_t)0x00000000)
